...
<div class="accordion" id="accordionExample">
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      <button class="btn text-start w-100 text-white border-bottom" type="button" data-bs-toggle="collapse"
        data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        <h4 class="my-1">Fakturaadress</h4>
      </button>
    </h2>
    <div id="collapseOne" class="accordion-show collapse show" aria-labelledby="headingOne"
      ...
      <div class="accordion-body pt-0">
        ...
        <div class="row gx-2">
          <div class="form-floating mt-3">
            <input type="text" class="form-control border-custom overlay1 <?= isInvalid('socialNumber') ?>"
              name="socialNumber" value="<?= @$user['socialNumber'] ?? set_value('socialnumber') ?>"
              data-mask="000000-0000" id="socialNumber" placeholder="Personnummer" data-parsley-length="[11,11]"
        ...
        <div class="row gx-2">
          <div class="form-floating col-sm mt-3">
            <input type="text" class="form-control border-custom overlay1 <?= isInvalid('firstname') ?>"
              name="firstname" value="<?= @$user['firstname'] ?? set_value('firstname') ?>" id="firstname"
              placeholder="Förnamn" data-parsley-pattern="[A-z]|Å|Ä|Ö|å|ä|ö"
              data-parsley-errors-container="#invalidFirstname" data-parsley-trigger="keyup change" required>
          ...
          <div class="form-floating col-sm mt-3">
            <input type="text" class="form-control border-custom overlay1 <?= isInvalid('lastname') ?>" name="lastname"
              ...
              data-parsley-pattern="[A-z]|Å|Ä|Ö|å|ä|ö" data-parsley-errors-container="#invalidLastname"
        ...
        <div class="row gx-2">
          <div class="form-floating col-sm mt-3">
            <input type="text" class="form-control border-custom overlay1 <?= isInvalid('city') ?>" name="city"
              ...
              data-parsley-pattern="[A-z]|Å|Ä|Ö|å|ä|ö" data-parsley-errors-container="#invalidCity"
              data-parsley-trigger="keyup change" required>
          ...
          <div class="form-floating col-sm mt-3">
            <input type="tel" class="form-control border-custom overlay1 <?= isInvalid('phone') ?>" name="phone"
              ...
              data-parsley-errors-container="#invalidphone" data-parsley-trigger="keyup change" required>
            ...
            <div class="input-group flex-nowrap input-group-lg">
              ...
              <div class="form-floating w-100">
                <input type="tel"
                  ...
                  name="cvc" value="<?= set_value('cvc') ?>" data-mask="000" placeholder="CVC"
                  data-parsley-type="digits" data-parsley-errors-container="#invalidCVC"
                  data-parsley-trigger="keyup change" required>
