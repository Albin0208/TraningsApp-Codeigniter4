...
<body>
    <?php $uri = service('uri'); ?>
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom bg-reda sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ps-2 <?= $uri->getSegment(1) == "about" ? "active" : null ?>" href="#">Om Elit-Träning</a>
                    </li>
                </ul>
    ...
    <footer class="text-white p-5 mat-2">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-4 me-auto">
                    <h4 class="text-uppercase fw-bold">Om Elit-träning</h4>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus eos suscipit accusamus minima animi quasi sapiente impedit, quae nam porro.</p>
                </div>
