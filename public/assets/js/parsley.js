...
(function (global, factory) {
  ...
  Parsley.addMessages("sv", {
    defaultMessage: "Fältet är ogiltigt.",
    type: {
      email: "Ange en giltig mailadress.",
      url: "Ange en giltig url.",
      number: "Ange ett nummer.",
      integer: "This value should be a valid integer.",
      digits: "Fältet får bara innehålla siffror.",
      alphanum: "Fältet får bara innehålla bokstäver och siffror.",
    },
    notblank: "Fältet får inte vara tomt.",
    required: "Fältet måste vara ifyllt.",
    pattern: "Värdet är inte giltigt.",
    min: "Fältet måste innehålla minst %s tecken.",
    max: "Fältet får innehålla max %s tecken.",
    range: "Värdet bör vara mellan %s och %s.",
    minlength: "För få tecken. Måste innehålla %s tecken eller fler.",
    maxlength: "För många tecken. Får vara max %s tecken.",
    length: "Fältet är ogiltigt. Det borde vara mellan %s och %s tecken.",
    mincheck: "You must select at least %s choices.",
    maxcheck: "You must select %s choices or fewer.",
    check: "You must select between %s and %s choices.",
    equalto: "Fältet matchar inte.",
